...
public class TransactionJUnitTest {
    ...
    public void testReadTranInformations() throws FileNotFoundException {
        ...
        //Method Read Information from File to Create and Fill the ArrayList
    ...
    public void testAddTransaction() throws IOException {
        ...
        Transaction Temp = new Transaction("1934", "Family Case",
                "Case Document12 .pdf", "Completed");
    ...
    public void testModifyTransaction() throws IOException {
        ...
        Transaction Temp = new Transaction("1122", "Civil Case",
                "Case Doc33.pdf", "Active");
        Transaction.AddTransaction("TestFile.txt", Temp); // save Object Info. On File
        // Start to Modify Object, Then Modify it on The Database "File"
        Transaction.ModifyTransaction("TestFile.txt",
                4, "Complete");// Modify Case Status To Complete,
    ...
    public void testDeleteTransaction() throws IOException {
        ...
        Transaction Temp = new Transaction("2288", "Criminal Case",
                "Criminal Case File.pdf", "Pending");
        Transaction.AddTransaction("TestFile.txt", Temp); // save Object Info. On File
        // After saving The Transaction to File,
        //Now Invoke DeleteTransaction to Remove from File
        Transaction.DeleteTrans("TestFile.txt", 0);// Modify Case Status To Complete,
                                    // 0 Indicates The Transaction Index on File, 
                                    // Since The File Empty It'll Be First One
