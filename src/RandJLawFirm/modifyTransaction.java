...
public class modifyTransaction extends javax.swing.JFrame {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(caseNum, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE)
                                .addComponent(caseTitle, javax.swing.GroupLayout.Alignment.LEADING))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(184, 184, 184)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (!caseNum.getText().equals(Transaction.transactions.get(index).getCaseNumber())) {
            
                // The method will only overwrite on previous value on the file
                Transaction.ModifytRans((index * 3) + 1, caseNum.getText());
                // modify on arraylist
        ...
        if (!caseTitle.getText().equals(Transaction.transactions.get(index).getCaseTitle())) {
                ...
                Transaction.ModifytRans((index * 3) + 2, caseTitle.getText());
        ...
        if (!Status.getText().equals(Transaction.transactions.get(index).getStatus())) {
                ...
                Transaction.ModifytRans((index * 3) + 3, Status.getText());
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        caseNum.setText(Transaction.transactions.get(index).getCaseNumber());
        caseTitle.setText(Transaction.transactions.get(index).getCaseTitle());
        Status.setText(Transaction.transactions.get(index).getStatus());
